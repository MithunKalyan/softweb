        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(0, 223, 253, 0.848),rgba(0,0,0,0.75)),url(background.jpg);
            ...
            footer {
                background-color: #0ef5ed;
                margin-top: auto;
            }
        </style>
    </head>
<body background="codevita.jpg">
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">C<span>ode</span>V<span>ita</span></h1>
            <ul>
        ...
        <div class="content">
            <div class="text">
                ...
                <br>
                <p>  Unlocking the World of Programming Excitement: CodeVita! </p>
                <p>Join the global coding community, battle it out with top coders, and explore exciting careers.</p>
                <br>
                <div>
    ...
    <footer>
        <center> Designed and Developed by Mithun Kalyan P (212223040142); 2024 </center>
    </footer>
</body>
</html>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(0, 253, 253, 0.848),rgba(0,0,0,0.75)),url(background.jpg);
                background-size: cover;
                background-position: center;
            }
            .navbar {
    ...
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="virattt.png"> </td>
                    <td> <img src="dhoniiii.webp"> </td>
                    <td> <img src="rainaaa.jpeg"> </td>
                    <td> <img src="abddd.jpeg"> </td>
                    <td> <img src="faffff.jpeg"> </td>
                    <td> <img src="maxiii.jpeg"> </td>
                </tr>
                <tr align="center">
                    <th> Virat Kohli </th>
                    <th> M S Dhoni </th>
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : Flat No:403,Tirumala SaiResidency,Nawabpeta,Nellore, Andhra Pradesh. </p>
                <p> <span>Email</span> : mithunkalyan23@gmail.com</p>
                <p> <span>Phone</span> : 9703050305 </p>
            </div>
        </div>
    </div>
    <footer>
...
## OUTPUT:
![kkkkkkkkout1](https://github.com/MithunKalyan/softweb/assets/148410106/b37bac99-761f-499f-ab4e-8eff30929c88)

![kkkkkkkkout2](https://github.com/MithunKalyan/softweb/assets/148410106/1d0a3780-445a-4032-a2c4-a545b639c3fc)

![kkkkkkkkout3](https://github.com/MithunKalyan/softweb/assets/148410106/91816022-d010-474e-84b8-27797a6ae03d)

![kkkkkkkkout4](https://github.com/MithunKalyan/softweb/assets/148410106/dd49093d-c192-4b8f-b29c-04111c1d8027)
